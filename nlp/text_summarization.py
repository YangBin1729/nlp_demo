...
cws_model_path = os.path.join(config['production'].LTP_DATA_DIR, 'cws.model')
...
class TextSummarizer():
    def __init__(self):
        ...
        self.model = Word2Vec.load(config['production'].Word2Vec_DIR)
...
if __name__ == '__main__':
    ...
    print(TextSummarizer().summarize(text, n=3))
